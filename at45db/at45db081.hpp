		...
		*/
		...
		public:
			...
			*/
    		...
    		Chimera::Modules::Memory::BlockStatus DiskOpen(const uint8_t volNum, Chimera::Modules::Memory::BlockMode openMode) override;
    		Chimera::Modules::Memory::BlockStatus DiskClose(const uint8_t volNum) override;
    		Chimera::Modules::Memory::BlockStatus DiskRead(const uint8_t volNum, const uint64_t sectorStart, const uint32_t sectorCount, void *const readBuffer) override;
    		Chimera::Modules::Memory::BlockStatus DiskWrite(const uint8_t volNum, const uint64_t sectorStart, const uint32_t sectorCount, const void *const writeBuffer) override;
